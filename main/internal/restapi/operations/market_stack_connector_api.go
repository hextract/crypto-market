...
// NewMarketStackConnectorAPI creates a new MarketStackConnector instance
func NewMarketStackConnectorAPI(spec *loads.Document) *MarketStackConnectorAPI {
	return &MarketStackConnectorAPI{
...
/*MarketStackConnectorAPI continuous market | stack connector */
type MarketStackConnectorAPI struct {
	spec            *loads.Document
...
func (o *MarketStackConnectorAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *MarketStackConnectorAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *MarketStackConnectorAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *MarketStackConnectorAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *MarketStackConnectorAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *MarketStackConnectorAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *MarketStackConnectorAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *MarketStackConnectorAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *MarketStackConnectorAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the MarketStackConnectorAPI
func (o *MarketStackConnectorAPI) Validate() error {
...
func (o *MarketStackConnectorAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *MarketStackConnectorAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *MarketStackConnectorAPI) Authorizer() runtime.Authorizer {
	return o.APIAuthorizer
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *MarketStackConnectorAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *MarketStackConnectorAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *MarketStackConnectorAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the market stack connector API
func (o *MarketStackConnectorAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *MarketStackConnectorAPI) initHandlerCache() {
...
func (o *MarketStackConnectorAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *MarketStackConnectorAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *MarketStackConnectorAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *MarketStackConnectorAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *MarketStackConnectorAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
