...
import (
	...
	"stack_connector/restapi/operations"
)

//go:generate swagger generate server --target ../../stack_connector --name Market --spec ../api/swagger/stack_connector.yaml --principal interface{}

func configureFlags(api *operations.MarketAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.MarketAPI) http.Handler {
